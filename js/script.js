document.addEventListener("DOMContentLoaded", function () {
  ...
  const books = {
    ...
    "deloproizvoditel-s-nulya-do-guru": {
      title: "Учебник «Делопроизводитель: с нуля до гуру»",
      filename: "deloproizvoditel-s-nulya-do-guru.pdf",
      description:
    ...
    "borba-s-somneniyami": {
      title:
        "Учебник «Фаберлик: Стоит ли игра свеч? Или честный разговор для тех, кто хочет, но боится»",
      filename: "borba-s-somneniyami.pdf",
      description:
        "Учебник для тех, кто сомневается: регистрироваться в Фаберлик или нет.",
      size: "8.9 МБ",
    },
  };
